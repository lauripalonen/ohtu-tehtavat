...
public class KauppaTest {
    ...
    @Test
    public void yrittaessaOstaaTuotettaJotaOnVarastossaJaTuotettaJotaEiOleVarastossaPankinMetodiaTilisiirtoKutsutaanOikeillaParametreilla(){
        when(viite.uusi()).thenReturn(42);
    ...
    public void metodiAloitaAsiointiNollaaEdellisenOstoksenTiedot(){
        ...
        k.aloitaAsiointi();
        k.lisaaKoriin(2);
        k.tilimaksu("pasi", "54321");

        verify(pankki).tilisiirto("pasi", 24, "54321", "33333-44455", 3);
    }
    ...
    public void metodiPoistaKoristaPalauttaaTuotteenVarastoon() {
        ...
        verify(varasto, times(1)).palautaVarastoon(varasto.haeTuote(1));
    }
